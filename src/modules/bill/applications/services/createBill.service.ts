...
import { FindManyConsumersByNamesQuery } from '@/modules/consumer/applications/queries/findManyConsumersByNames/findManyConsumersByNames.query';
import { FindManyUsersConsumersByRefIdAndTargetIdsQuery } from '@/modules/consumer/applications/queries/findManyUsersConsumersByRefIdAndTargetIds/findManyUsersConsumersByRefIdAndTargetIds.query';
